  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FFF9F0]">
      ...
      <main className="flex-1">
        {/* Seção Principal: Título com efeito circular e introdução */}
        <section className="relative bg-gradient-to-br from-[#3d0a49] to-[#5015bd] text-white overflow-hidden border-b-8 border-double border-[#00caf8]">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            {/* Texto circular com as frases da Reforma Psiquiátrica */}
            ...
            {/* Texto de resumo e botões de ação principal */}
        ...
        {/* Seção de Números: Dados rápidos sobre o evento */}
        <section className="py-16 bg-white border-b-4 border-double border-[#027fe9]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <ScrollReveal animation="fade-up" delay={0}>
                <div className="text-center group">
                  <div className="inline-flex items-center justify-center w-20 h-20 bg-[#5015bd] border-4 border-[#3d0a49] mb-4 shadow-[4px_4px_0px_0px_rgba(80,21,189,0.5)]">
                    <BookOpen className="w-10 h-10 text-white" />
                  </div>
                  <div className="text-5xl font-bold text-[#5015bd] mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>9</div>
                  <div className="text-[#3d0a49] uppercase tracking-wide text-sm font-semibold">Projetos em Destaque</div>
                </div>
              </ScrollReveal>
              
              <ScrollReveal animation="fade-up" delay={200}>
                <div className="text-center group">
                  <div className="inline-flex items-center justify-center w-20 h-20 bg-[#027fe9] border-4 border-[#3d0a49] mb-4 shadow-[4px_4px_0px_0px_rgba(2,127,233,0.5)]">
                    <Users className="w-10 h-10 text-white" />
                  </div>
                  <div className="text-5xl font-bold text-[#027fe9] mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>18</div>
                  <div className="text-[#3d0a49] uppercase tracking-wide text-sm font-semibold">Pesquisadores Envolvidos</div>
                </div>
              </ScrollReveal>
              
              <ScrollReveal animation="fade-up" delay={400}>
                <div className="text-center group">
                  <div className="inline-flex items-center justify-center w-20 h-20 bg-[#00caf8] border-4 border-[#3d0a49] mb-4 shadow-[4px_4px_0px_0px_rgba(0,202,248,0.5)]">
                  ...
                  <div className="text-[#3d0a49] uppercase tracking-wide text-sm font-semibold">Áreas de Estudo</div>
                </div>
              </ScrollReveal>
            </div>
          </div>
        ...
        {/* Seção de Destaques: Carrossel com os principais projetos */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal animation="fade-down">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-[#5015bd] max-w-2xl mx-auto leading-relaxed">
          ...
          <ScrollReveal animation="fade-up">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="text-xl text-white/95 mb-10 leading-relaxed">
                Você é estudante de psicologia e deseja compartilhar seu projeto aqui? Entre em contato com a coordenação para adicionar seu trabalho.
              </p>
              <a
                href="https://mail.google.com/mail/?view=cm&to=obsamufj@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white text-[#5015bd] px-8 py-4 border-2 border-[#3d0a49] font-bold hover:bg-[#00caf8] hover:text-white transition-all shadow-[4px_4px_0px_0px_rgba(0,202,248,0.5)]"
              >
                Entre em Contato
              </a>
            </div>
