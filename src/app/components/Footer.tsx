      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-[#5015bd] dark:text-white leading-relaxed mb-4" style={{ fontFamily: 'Crimson Text, serif' }}>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/" className="text-[#5015bd] dark:text-white hover:text-[#027fe9] dark:hover:text-[#00caf8] transition-colors flex items-center gap-2 group font-medium">
                  <span className="text-[#00caf8] group-hover:translate-x-1 transition-transform">›</span> Início
                </a>
              </li>
              <li>
                <a href="/projetos" className="text-[#5015bd] dark:text-white hover:text-[#027fe9] dark:hover:text-[#00caf8] transition-colors flex items-center gap-2 group font-medium">
                  <span className="text-[#00caf8] group-hover:translate-x-1 transition-transform">›</span> Projetos
                </a>
              </li>
              <li>
                <a href="/sobre" className="text-[#5015bd] dark:text-white hover:text-[#027fe9] dark:hover:text-[#00caf8] transition-colors flex items-center gap-2 group font-medium">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2">
                ...
                <p className="text-[#5015bd] dark:text-white leading-relaxed">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="https://mail.google.com/mail/?view=cm&to=obsamufj@gmail.com" target="_blank" rel="noopener noreferrer" className="text-[#5015bd] dark:text-white hover:text-[#027fe9] dark:hover:text-[#00caf8] transition-colors font-medium">
                  obsamufj@gmail.com
                </a>
              </div>
            </div>
        ...
        <div className="border-t-2 border-[#5015bd]/20 dark:border-white/20 mt-8 pt-8 text-center">
          <p className="text-sm text-[#5015bd] dark:text-white" style={{ fontFamily: 'Crimson Text, serif' }}>
