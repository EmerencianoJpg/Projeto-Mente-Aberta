        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="bg-[#027fe9] p-2 border-2 border-[#3d0a49] hover:bg-[#5015bd] transition-all hover:scale-110 shadow-[3px_3px_0px_0px_rgba(2,127,233,0.4)]">
                <Youtube className="w-5 h-5 text-white" />
              </a>
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="bg-[#00caf8] p-2 border-2 border-[#3d0a49] hover:bg-[#027fe9] transition-all hover:scale-110 shadow-[3px_3px_0px_0px_rgba(0,202,248,0.4)]">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/" className="text-[#5015bd] dark:text-white hover:text-[#027fe9] transition-colors flex items-center gap-2 group font-medium">
                  <span className="text-[#00caf8] group-hover:translate-x-1 transition-transform">›</span> Início
                </a>
              </li>
              <li>
                <a href="/projetos" className="text-[#5015bd] dark:text-white hover:text-[#027fe9] transition-colors flex items-center gap-2 group font-medium">
                  <span className="text-[#00caf8] group-hover:translate-x-1 transition-transform">›</span> Projetos
                </a>
              </li>
              <li>
                <a href="/sobre" className="text-[#5015bd] dark:text-white hover:text-[#027fe9] transition-colors flex items-center gap-2 group font-medium">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-[#027fe9] dark:text-[#00caf8] mt-1 flex-shrink-0" />
                <p className="text-[#5015bd] dark:text-white/90! leading-relaxed">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="https://mail.google.com/mail/?view=cm&to=obsamufj@gmail.com" target="_blank" rel="noopener noreferrer" className="text-[#5015bd] dark:text-white/90! hover:text-[#027fe9] transition-colors font-medium">
                  obsamufj@gmail.com
                </a>
              </div>
            </div>
