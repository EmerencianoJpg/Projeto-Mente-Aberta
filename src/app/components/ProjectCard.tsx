...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <Link 
      to={`/projeto/${project.id}`} // Navegação para detalhes ao clicar 
      // Container principal
    ...
    >
      {/* Renderiza vídeo ou imagem dependendo do tipo da capa */}
      <div className="relative h-56 overflow-hidden bg-[#e0daf7] border-b-4 border-[#5015bd] shrink-0">
        ...
        {/* Etiqueta flutuante com a área de estudo/curso */}
